...
########################################  METHODS
# Functions for Latin (hyper)squares generalized to nv dimensions
# needed for shift of tiling to make the whole tiles design an LHD
...
def strat_sample_by_tiling(nv, ns, t, tile_type = 'MC', median = True, my_tile = None, one_tile = True,\
    ...
    '''
    Tile the provided point sample to generate a tiled point set.
    ...
    Parameters:
        ...
        tile_type (str): Sampling method used for generation of tiles.
                         Options: 'LH' (Latin Hypercube Sample), 'SRS' (Simple Random Sampling).
        ...
        t_shifts (bool): Triggers minor coordinate shifts to achieve regular 1D projections, see Eq. (5).
    ...
    # these tiles have edge length 1 and they are located in the unit hypercube starting in the origin
    # shape: (T,ns,nv) 
